...
class ClearLinkPager extends LinkPager
{
	/**
     * @var HTML attribute for the pager container
     */
    public $containerTag = 'ul';

	/**
     * @var HTML attribute for the item in pager
     */
    public $itemTag = 'li';
    ...
    protected function renderPageButton($label, $page, $class, $disabled, $active)
    {
        ...
        if ($disabled) {
            ...
            return Html::tag($this->itemTag, Html::tag('span', $label), $options);
        }
